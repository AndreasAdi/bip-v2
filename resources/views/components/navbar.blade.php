<nav class="fixed top-0 left-0 z-40 w-full text-white bg-transparent navbar dark:bg-gray-900">
    <div class="flex flex-wrap items-center justify-between max-w-screen-xl p-4 mx-auto ">
        ...
        <div class="hidden w-full md:block md:w-auto" id="navbar-dropdown">
            <ul
                ...
                <li>
                    <a href="/katalog"
                        class="flex items-center justify-between w-full py-2 pl-3 pr-4 font-semibold rounded hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-bip-orange-400 md:p-0 md:w-auto dark:text-white md:dark:hover:text-orange-500 dark:focus:text-white dark:border-gray-700 dark:hover:bg-gray-700 md:dark:hover:bg-transparent">Katalog</a>
                </li>
                <li>
                    <a href="#"
            ...
            <button type="button"
                class="w-full px-6 py-2 font-bold text-center text-white rounded-full bg-gradient-to-tr from-bip-orange-400 to-bip-orange-500 hover:bg-gradient-to-br hover:from-bip-orange-400 hover:to-bip-orange-300 focus:ring-4 focus:outline-none focus:ring-orange-300 text-md md:mr-0 dark:bg-orange-600 dark:hover:bg-orange-700 dark:focus:ring-orange-800 md:hidden">
                Karir
            </button>

            <button type="button"
                class="w-full px-6 py-2 mt-3 font-bold text-center text-white bg-blue-600 rounded-full hover:bg-blue-500 focus:ring-4 focus:outline-none focus:ring-blue-300 text-md md:mr-0 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800 md:hidden">
                Contact
            </button>
        </div>
